...
import { Table, Card,Tag, Divider, Popconfirm, Button, Modal, Form, Input, Radio, Select,notification,Row,Col, Icon,InputNumber } from 'antd';
		...
		return(
			<div>
        		...
        		<Card 
		          title="检查项信息"
		          bordered={false} 
		          extra={<Button type="primary" onClick={()=>{this.handleAdd()}} >新增检查</Button>}
		        >
	        	<Row>
           			<Col span={4}>
