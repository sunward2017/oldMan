      ...
      <Fragment>
        ...
        >
          <Meta
            ...
            title={data.name}
            description={<span>性别:&emsp;<Tag color="#108ee9" style={{marginBottom:10}}>{data.sex===1?'男':'女'}</Tag><br/>年龄:&emsp;<Tag color="orange" style={{marginBottom:10}}>{data.age}</Tag>岁<br/>出院日期:&emsp;{date}</span>}
          />
        </Card>
        {
          modalFlag?
