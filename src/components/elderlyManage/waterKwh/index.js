...
import {Row,Col,Button,Select,Input,DatePicker,Divider,Popconfirm,Table,Form,notification,Modal,TreeSelect,Icon,InputNumber,Card,List,Avatar} from 'antd';
              ...
              <List.Item>
                <List.Item.Meta
                  ...
                  description={<div>
                    ...
                    <Select placeholder="请选择房间" value={action==='add'?roomCode:roomName} onChange={this.handleSelectChange} style={{width:300}}>
