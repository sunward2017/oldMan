...
class WorkProjects extends Component{
  ...
  handleOnSelect(selectedKeys,params){
    ...
    this.setState({selectedKeys,nursingGradeCode,nursingGradeName,tabKey:'tab1',customerId,},()=>{
  ...
  //添加
  handleClickAdd(){
    const {selectedKeys,nursingGradeName,nursingGradeCode} = this.state;
    ...
    this.setState({ tabKey:'tab2',record:{nursingGradeName,nursingGradeCode},action:'',edit:false,});
  }
